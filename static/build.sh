...
dat datos.dat -a ./level1_funky.mid -h statics.h -t MIDI
dat datos.dat -a ./level2_policiaco.mid -h statics.h -t MIDI
dat datos.dat -a ./level3.mid -h statics.h -t MIDI
...
dat lang.dat -a ./menu_font.fnt -h langs.h 
